...
csdat2017 = suppressWarnings(read.csv("D:/Work/2017_data/SXF/SXF_43.69-96.58.csv"
                                      , header = TRUE)) 
...
bin1 = na.sorted[1:538,2] #bin one includes 1 and 2 consecutive na's
na1 = which(is.na(Kt.observed[bin1]))
bin1 = bin1[-na1]

bin2 = na.sorted[539:1997, 2] #bin two includes 3 + consecutive na's
summary(Kt.observed[bin2])
na2 = which(is.na(Kt.observed[bin2]))
bin2 = bin2[-na2]

bin3 = na.sorted[1:892,2] #bin three inclueds 1-3 consecutive na's
summary(Kt.observed[bin3])
na3 = which(is.na(Kt.observed[bin3]))
bin3 = bin3[-na3]

bin4 = na.sorted[893:1997, 2] #bin four includes 4 + consecutive na's
summary(Kt.observed[bin4])
na4 = which(is.na(Kt.observed[bin4]))
bin4 = bin4[-na4]

bin5 = na.sorted[1:310,2] #bin five includes singular na values
summary(Kt.observed[bin5])
na5 = which(is.na(Kt.observed[bin5]))
#bin5 = bin5[-na5]

bin6 = na.sorted[311:1997, 2] #bin six includes 2+ consecutive na's
