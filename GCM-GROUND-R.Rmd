...
ground_dat = suppressWarnings(read.csv("D:/Work/Ground_measured_data/GCM.csv"
                                      , header = TRUE, sep = ",")) 
...
# na = c(rep(1, 283), rep(2, 102), rep(3, 131), rep(4, 111), rep(5, 27), 6, 8, 48)

n = c(283, 102, 131, 111, 27, 1, 1, 1) # first 7 col -- clear; next 7 col -- cloudy
m = matrix(c(1:30, 31:60, 61:90, 91:120, 121:150, 151:180, 211:240, 1441:1470), ncol = 8)
...
k4 = detect_index(na.sorted$V1, function(x){x == 123})
