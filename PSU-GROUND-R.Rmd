...
ground_dat = suppressWarnings(read.csv("D:/Work/Ground_measured_data/PSU.csv"
                                      , header = TRUE, sep = ",")) 
...
# na = na = c(rep(1, 289), rep(2, 104), rep(3, 155), rep(4, 175), rep(5, 59), rep(6, 19), rep(7,2), 11, 48)

n = c(289, 104, 155, 175, 59, 19, 2, 11, 48) # first 7 col -- clear; next 7 col -- cloudy
m = matrix(c(1:30, 31:60, 61:90, 91:120, 121:150, 151:180, 181:210, 331:360, 1441:1470), ncol = 9)
...
k4 = detect_index(na.sorted$V1, function(x){x == 122})
 
k5 = detect_index(na.sorted$V1, function(x){x == 154})
# 
