...
csdat2017 = suppressWarnings(read.csv("D:/Work/2017_data/NREL/NREL_39.69-105.14.csv"
                                      , header = TRUE)) 
...
na = c(rep(1, 397), rep(2, 119), rep(3, 145), rep(4, 225), rep(5, 56), rep(6, 13), 7, rep(8,2), 10)
summary(na)
...
bin1 = na.sorted[1:635,2] #bin one includes 1 and 2 consecutive na's
na1 = which(is.na(Kt.observed[bin1]))
bin1 = bin1[-na1]

bin2 = na.sorted[636:2361, 2] #bin two includes 3 + consecutive na's
summary(Kt.observed[bin2])
na2 = which(is.na(Kt.observed[bin2]))
bin2 = bin2[-na2]

bin3 = na.sorted[1:1070,2] #bin three inclueds 1-3 consecutive na's
summary(Kt.observed[bin3])
na3 = which(is.na(Kt.observed[bin3]))
bin3 = bin3[-na3]

bin4 = na.sorted[1071:2361, 2] #bin four includes 4 + consecutive na's
summary(Kt.observed[bin4])
na4 = which(is.na(Kt.observed[bin4]))
bin4 = bin4[-na4]

bin5 = na.sorted[1:397,2] #bin five includes singular na values
summary(Kt.observed[bin5])
na5 = which(is.na(Kt.observed[bin5]))
#bin5 = bin5[-na5]

bin6 = na.sorted[398:2361, 2] #bin six includes 2+ consecutive na's
