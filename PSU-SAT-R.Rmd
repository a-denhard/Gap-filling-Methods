...
csdat2017 = suppressWarnings(read.csv("D:/Work/2017_data/PSU/PSU_40.69-77.90.csv"
                                      , header = TRUE)) 
...
na = c(rep(1, 289), rep(2, 104), rep(3, 155), rep(4, 175), rep(5, 59), rep(6, 19), rep(7,2), 11, 48)
summary(na)
...
bin1 = na.sorted[1:497,2] #bin one includes 1 and 2 consecutive na's
na1 = which(is.na(Kt.observed[bin1]))
bin1 = bin1[-na1]

bin2 = na.sorted[498:2144, 2] #bin two includes 3 + consecutive na's
summary(Kt.observed[bin2])
na2 = which(is.na(Kt.observed[bin2]))
bin2 = bin2[-na2]

bin3 = na.sorted[1:962,2] #bin three inclueds 1-3 consecutive na's
summary(Kt.observed[bin3])
na3 = which(is.na(Kt.observed[bin3]))
bin3 = bin3[-na3]

bin4 = na.sorted[963:2144, 2] #bin four includes 4 + consecutive na's
summary(Kt.observed[bin4])
na4 = which(is.na(Kt.observed[bin4]))
bin4 = bin4[-na4]

bin5 = na.sorted[1:289,2] #bin five includes singular na values
summary(Kt.observed[bin5])
na5 = which(is.na(Kt.observed[bin5]))
#bin5 = bin5[-na5]

bin6 = na.sorted[290:2144, 2] #bin six includes 2+ consecutive na's
