...
ground_dat = suppressWarnings(read.csv("D:/Work/Ground_measured_data/DRA.csv"
                                      , header = TRUE, sep = ",")) 
...
# na = c(rep(1, 426), rep(2, 125), rep(3, 135), rep(4, 87), rep(5, 17), 6)

n = c(426, 125, 135, 87, 17, 1) # first 7 col -- clear; next 7 col -- cloudy
m = matrix(c(1:30, 31:60, 61:90, 91:120, 121:150, 151:180), ncol = 6)
