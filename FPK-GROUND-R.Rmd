...
ground_dat = suppressWarnings(read.csv("D:/Work/Ground_measured_data/FPK.csv"
                                      , header = TRUE, sep = ",")) 
...
n = c(402, 139, 82, 205, 71, 41, 21, 6, 2, 1, 2, 2, 5, 1, 5, 6, 1, 1) # first 7 col -- clear; next 7 col -- cloudy
m = matrix(c(1:30, 31:60, 61:90, 91:120, 121:150, 151:180, 181:210, 211:240, 241:270, 271:300, 301:330, 331:360, 361:390, 391:420, 421:450, 451:480, 481:510, 511:540), ncol = 18)
...
c(x, ratio, index) := f(x, n[3], m[,3], max_iter = 1000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) :=  f(x, n[4], m[,4], max_iter = 10000, ratio, index)
summary(x)
length(ratio)
...
c(x, ratio, index) :=  f(x, n[6], m[,6], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) :=  f(x, n[7], m[,7], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[8], m[,8], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[9], m[,9], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[10], m[,10], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[11], m[,11], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[12], m[,12], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[13], m[,13], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[14], m[,14], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[15], m[,15], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[16], m[,16], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[17], m[,17], max_iter = 10000, ratio, index)
summary(x)
length(ratio)

c(x, ratio, index) := f(x, n[18], m[,18], max_iter = 10000, ratio, index)
summary(x)
length(ratio)
...
k5 = detect_index(na.sorted$V1, function(x){x > 150})
# 
